                        ...
                        <div class="float-right">
                            <div class="dropdown d-inline-block">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <router-link to="/logout"><i class="mdi mdi-logout font-size-16 align-middle mr-1"></i> Logout</router-link>
                                </div>
                            </div>
                        </div>
...
export default {
  data() {
    return {
      ...
      hitung1: parseInt(localStorage.pilih) + (40000 + Math.floor(Math.random()*1000)),
      hitung2: parseInt(localStorage.pilih) + (130000 + Math.floor(Math.random()*1000)),
    }
  },
  methods: {
    next() {
